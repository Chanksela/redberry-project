export const TextContentArray = [
  ...
  "Hey guys. Click Submit to sent POST request on api. Unfortinantly I couldn't finish the project on time, so if all answer aren't written/chosen, POST request fails.",
];
export const InputTitleArray = [
  "Hey, Rocketeer, what are your corrdinates?",
  "Tell us about your skills",
  "Covid Stuff",
  "What about you?",
];
export const TextTitleArray = [
  "Redberry Origins",
